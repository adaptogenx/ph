--[[
    UI_History_Filters.lua - Filter bar component for pH History
...
-- Initialize
--------------------------------------------------
function pH_History_Filters:Initialize(parent, historyController)
    self.parent = parent
    ...
    searchBox:SetScript("OnTextChanged", function(self)
        pH_History_Filters:OnSearchChanged(self:GetText())
    end)
    ...
    sortBtn:SetScript("OnClick", function(self)
        pH_History_Filters:ShowSortMenu(self)
    end)
    ...
    zoneBtn:SetScript("OnClick", function(self)
        pH_History_Filters:ShowZoneMenu(self)
    end)
    ...
    charBtn:SetScript("OnClick", function(self)
        pH_History_Filters:ShowCharMenu(self)
    end)
...
--------------------------------------------------
function pH_History_Filters:CreateDropdownButton(parent, text, width)
...
-- Show Sort Menu
--------------------------------------------------
function pH_History_Filters:ShowSortMenu(button)
    if not self.sortMenu then
        self.sortMenu = CreateFrame("Frame", "pH_SortMenu", button, "UIDropDownMenuTemplate")
    end
...
-- Show Zone Menu
--------------------------------------------------
function pH_History_Filters:ShowZoneMenu(button)
    if not self.zoneMenu then
        self.zoneMenu = CreateFrame("Frame", "pH_ZoneMenu", button, "UIDropDownMenuTemplate")
    end
...
-- Show Character Menu
--------------------------------------------------
function pH_History_Filters:ShowCharMenu(button)
    if not self.charMenu then
        self.charMenu = CreateFrame("Frame", "pH_CharMenu", button, "UIDropDownMenuTemplate")
    end
    ...
    UIDropDownMenu_Initialize(menu, function()
        ...
        -- Add characters
        local chars = pH_Index:GetCharacters()
...
--------------------------------------------------
function pH_History_Filters:UpdateCharDropdownLabel()
...
--------------------------------------------------
function pH_History_Filters:UpdateFlagsLabel()
    local parts = {}
...
function pH_History_Filters:ShowFlagsMenu(button)
    if not self.flagsMenu then
        self.flagsMenu = CreateFrame("Frame", "pH_FlagsMenu", button, "UIDropDownMenuTemplate")
    end
...
--------------------------------------------------
function pH_History_Filters:OnSearchChanged(text)
...
--------------------------------------------------
function pH_History_Filters:OnFilterChanged()
    -- Trigger list refresh
    self.historyController:RefreshList()
end

-- Export module
_G.pH_History_Filters = pH_History_Filters
