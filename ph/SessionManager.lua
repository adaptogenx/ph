...
-- luacheck: globals GetMaxPlayerLevel UnitLevel UnitXP UnitXPMax UnitClass pH_DB_Account pH_Settings UnitName GetRealmName UnitFactionGroup
...
function pH_SessionManager:GetSession(sessionId)
    return pH_DB_Account.sessions[sessionId]
end
